...
export function isStringArray(possibleStringArray: any): possibleStringArray is string[] {
  return Array.isArray(possibleStringArray) && possibleStringArray.reduce((a, b) => a && typeof b === 'string', true)
}
